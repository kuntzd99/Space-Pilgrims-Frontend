  ...
  return (
    <div className="profile">
      ...
      <div className="profile card" key={props.pilgrim.id}>
          ...
          <Mailbox setHeader={props.setHeader} setErrorMessage={props.setErrorMessage} openModal={props.openModal} setOpenModal={props.setOpenModal} pilgrim={props.pilgrim} messages={props.messages} setMessages={props.setMessages} />
